                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body">
                            ...
                            <p><strong>Issued_at:</strong> {{ $certificate->issued_at }}</p>
                            <p><strong>Issued_by:</strong> {{ $certificate->issued_by }}</p>
                        </div>
                        <div class="card-footer">
                            <a class="btn btn-primary" href="{{ route('certificate.index') }}">Back</a>
                        </div>
                    </div>
                    <!-- End of Card -->
