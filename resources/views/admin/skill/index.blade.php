        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <a href="{{ route('skill.create') }}" class="btn btn-success mb-3" onclick="showCreateAlert()">Create</a>
                    <table id="myTable" class="table table-bordered table-striped table-hover">
                        ...
                        <tbody> 
                            ...
                            <td class="align-middle text-center">{{ $no+1 }}</td>
                                ...
                                <td class="align-middle text-center">
                                    <a class="btn btn-warning btn-sm mb-2" href="{{ route('skill.show', $row) }}">Detail</a>
                                    <a class="btn btn-primary btn-sm mb-2" href="{{ route('skill.edit', $row) }}" onclick="showEditAlert()">Edit</a>
                                    <form action="{{ route('skill.destroy', $row->id) }}" method="POST" class="delete-form">
                                        @csrf
                                        @method('DELETE')
