                    ...
                    <div class="row justify-content-center"> 
                        <div class="col-md-8">
                            <div class="card shadow-lg">
                                <div class="card-body">
                                    <form id="createForm" action="{{ route('about.store') }}" method="POST" enctype="multipart/form-data" onsubmit="return submitForm(event)">
                                        @csrf
                                        <div class="mb-4">
                                            <label for="title" class="form-label">Title</label>
                                            <input type="text" class="form-control custom-input" name="title" id="title" placeholder="Enter your title" required>
                                        </div>
                                        <div class="mb-4">
                                        ...
                                        <div class="mb-4">
                                            <label for="image" class="form-label">Upload Image (jpeg, jpg, png)</label>
