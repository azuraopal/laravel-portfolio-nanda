            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body">
                            <p><strong>Name:</strong> {{ $projek->name }}</p>
                            <p><strong>Description:</strong> {{ $projek->description }}</p>
                            <p><strong>Link:</strong> {{ $projek->link }}</p>
                            <p><strong>Date:</strong> {{ $projek->date }}</p>
                        </div>
