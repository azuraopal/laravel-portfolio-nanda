        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                Swal.fire({
                    ...
                    timer: 3000 // Alert will automatically disappear after 3 seconds
                });
            });
        </script>
        @endif
...
<!-- Add bg-light to the following section to apply background color -->
<div class="d-flex flex-wrap justify-content-center bg-light py-4">
    <!-- Address -->
